...
ARGON2_PUBLIC void fill_block_withIndex(const block *prev_block, const block *ref_block,
	block *next_block, int with_xor, uint32_t block_header[8], uint32_t index);

ARGON2_PUBLIC void initial_hash(uint8_t *blockhash, argon2_context *context,
	argon2_type type);
